...
if [ $ARCH == "riscv64" ]; then
    ...
    sudo cp -rfd overlay-sophgo-riscv64/usr/lib/libatomic.so* $TARGET_ROOTFS_DIR/usr/lib/
    ...
    sudo cp -rfd overlay-sophgo-arm64/usr/lib/libatomic.so* $TARGET_ROOTFS_DIR/usr/lib/
